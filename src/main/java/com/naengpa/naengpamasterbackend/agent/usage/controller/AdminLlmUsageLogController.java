...
public class AdminLlmUsageLogController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<List<AdminLlmUsageLogResponse>>> findAllUsageLogs() {
        List<AdminLlmUsageLogResponse> response = adminLlmUsageLogService.findAllUsageLogs();
